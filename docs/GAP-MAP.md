...
| ID          | Domain  | Gap                                                                                                                                                                                                                                                                                                                                                                                                           | Effort |
| ----------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| ~~**C18**~~ | Auth    | ~~WebAuthn hardware-key enforcement for `super_admin` payout instruction not wired~~ **CLOSED 2026-06-14** — `WebAuthnCredential` Prisma model + migration; register/assert service (simplewebauthn v13); HMAC step-up token (≤5min, MFA_STEP_UP_SECRET); `requireWebAuthnStepUp` preHandler; payout lock + instruction-file gated; `tsc` clean                                                               | M      |

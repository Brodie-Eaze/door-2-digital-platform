...
export default function InsideSalesPage(): JSX.Element {
  return (
    <OrgShell pageTitle="Inside sales · Dialer">
        ...
        <div className="grid grid-cols-12 gap-4" style={{ minHeight: 600 }}>
          ...
          <div className="col-span-3 card !p-0 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              {QUEUE.map((c, i) => (
                <div
                  key={c.phone}
                  className={`px-4 py-3 border-b border-line2 hover:bg-paper cursor-pointer ${
                    i === 0 ? 'bg-accentSoft border-l-2 border-l-accent' : ''
                  }`}
                >
          ...
          <div className="col-span-6 card !p-0 flex flex-col">
            <div className="px-5 py-3 border-b border-line2 flex items-center justify-between bg-paper/40">
              <div>
                <div className="text-base font-semibold text-ink">Maria Santos</div>
                <div className="text-[12px] text-muted">
                  +1 512 555 0182 · 4218 Lakeview, Austin TX
                </div>
              </div>
            ...
            <div className="border-t border-line2 bg-ink text-surface px-5 py-3 flex items-center gap-3">
              <button className="w-10 h-10 rounded-full bg-surface/10 hover:bg-surface/20 flex items-center justify-center">
                <Mic size={16} />
              </button>
              <button className="w-10 h-10 rounded-full bg-surface/10 hover:bg-surface/20 flex items-center justify-center">
                <PhoneCall size={16} />
              </button>
              <button className="w-10 h-10 rounded-full bg-rose-500 hover:bg-rose-600 flex items-center justify-center">
                <PhoneOff size={16} />
              </button>
